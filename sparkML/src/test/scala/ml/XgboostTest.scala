...
//
//  object XgboostTest extends App {
//
...
//    )
//
////    val sparkConf = new SparkConf().setAppName("xgb-test").set(
...
//    val vecDf = assembler.transform(newDf).drop("gender","age","yearsmarried", "children", "religiousness","education", "occupation", "rating")
//
//    vecDf.show(20)
//
...
////    newDf.show(20)
////
////    val trainData = newDf.foreach{line =>
////      val label = line(0).toString.toDouble
////      val value0 = (1 to 8).map(i => line(i).toString.toDouble)
////      val featureVec = Vectors.dense(value0.toArray)
////      LabeledPoint(label, featureVec)
////    }
////
////
////    println(trainData.getClass.getSimpleName)
//
//
//    val numRound = 800
...
//
//    val xgboostModel = XGBoost.trainWithDataFrame(trainData, paramMap, numRound, nWorkers = 2)
